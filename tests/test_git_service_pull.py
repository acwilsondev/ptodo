...
class TestGitServicePull:
    ...
    def test_pull_success(self, mock_discover_repository, temp_dir):
    ...
    def test_pull_no_remote(self, mock_discover_repository, temp_dir):
    ...
    def test_pull_merge_conflicts(self, mock_discover_repository, temp_dir):
    ...
    def test_pull_network_error(self, mock_discover_repository, temp_dir):
    ...
    def test_pull_not_a_repository(self, mock_discover_repository):
