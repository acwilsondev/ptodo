...
class TestOrganizationCommands:
    ...
    def mock_git_service(self):
        ...
        with patch("ptodo.commands.organization_commands.GitService") as mock_service_class:
    ...
    def mock_todo_file_path(self):
        ...
        with patch("ptodo.commands.organization_commands.get_todo_file_path") as mock_get_path:
    ...
    @pytest.fixture
    def mock_done_file_path(self):
        """Mock get_done_file_path function."""
        with patch("ptodo.commands.organization_commands.get_done_file_path") as mock_get_path:
            # Mock a Path object with a parent attribute
            mock_path = MagicMock(spec=Path)
            mock_path.parent = Path("/mock/path")
            mock_get_path.return_value = mock_path
    ...
    def sample_tasks(self):
        ...
        task1 = Task(description="Sample task 1", projects={"project1", "project2"}, contexts={"context1"})
        task2 = Task(description="Sample task 2", completed=True, projects={"project1"}, contexts={"context2"})
        task3 = Task(description="Sample task 3", priority="A", projects={"project3"}, contexts={"context1"})
        return [task1, task2, task3]

    # Tests for cmd_archive
    def test_archive_success(self, mock_git_service, mock_todo_file_path, 
                           mock_done_file_path, mock_read_tasks, mock_write_tasks, 
                           sample_tasks, capsys):
    ...
    def test_archive_no_completed_tasks(self, mock_git_service, mock_todo_file_path, 
                                       mock_done_file_path, mock_read_tasks, 
                                       mock_write_tasks, capsys):
    ...
    def test_projects_success(self, mock_git_service, mock_todo_file_path, 
                            mock_read_tasks, sample_tasks, capsys):
    ...
    def test_projects_no_projects(self, mock_git_service, mock_todo_file_path, 
                                mock_read_tasks, capsys):
    ...
    def test_contexts_success(self, mock_git_service, mock_todo_file_path, 
                            mock_read_tasks, sample_tasks, capsys):
    ...
    def test_contexts_no_contexts(self, mock_git_service, mock_todo_file_path, 
                                mock_read_tasks, capsys):
    ...
    def test_project_mv_success(self, mock_git_service, mock_todo_file_path, 
                              mock_read_tasks, mock_write_tasks, sample_tasks, capsys):
        ...
        for task in modified_tasks:
            ...
            if "new_project" in task.projects or "project2" in task.projects or "project3" in task.projects:
    ...
    def test_project_mv_project_not_found(self, mock_git_service, mock_todo_file_path, 
                                        mock_read_tasks, mock_write_tasks, sample_tasks, capsys):
    ...
    def test_project_rm_success(self, mock_git_service, mock_todo_file_path, 
                              mock_read_tasks, mock_write_tasks, sample_tasks, capsys):
    ...
    def test_project_rm_project_not_found(self, mock_git_service, mock_todo_file_path, 
                                        mock_read_tasks, mock_write_tasks, sample_tasks, capsys):
    ...
    def test_project_pri_set_priority_success(self, mock_git_service, mock_todo_file_path, 
                                           mock_read_tasks, mock_write_tasks, sample_tasks, capsys):
    ...
    def test_project_pri_remove_priority_success(self, mock_git_service, mock_todo_file_path, 
                                              mock_read_tasks, mock_write_tasks, sample_tasks, capsys):
    ...
    def test_project_pri_invalid_priority(self, mock_git_service, mock_todo_file_path, 
                                       mock_read_tasks, mock_write_tasks, sample_tasks, capsys):
    ...
    def test_project_pri_project_not_found(self, mock_git_service, mock_todo_file_path, 
                                        mock_read_tasks, mock_write_tasks, sample_tasks, capsys):
