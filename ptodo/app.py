...
from .commands.task_commands import cmd_list, cmd_add, cmd_done, cmd_pri, cmd_show
from .commands.organization_commands import cmd_projects, cmd_contexts, cmd_archive
...
def main(args: Optional[List[str]] = None) -> int:
    ...
    # Git commands
    git_init_parser = subparsers.add_parser("git-init", help="Initialize Git repository")
